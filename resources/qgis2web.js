...
map.getView().fit([-8241105.442913, -2659202.528369, -5907566.166081, -1043086.158310], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Atractivos Turisticos en TCOs</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (105 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Mapa De Ubicacion de Atractivos Turisticos<br />en Tierras Comunitarias de Origen<br />Desarrollado por Franz Ramos';
            }
